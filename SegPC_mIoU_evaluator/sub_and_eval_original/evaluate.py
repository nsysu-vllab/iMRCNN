...
#gt_path = './gt_rez_ins'
gt_path = '/home/frank/Desktop/instance segmentation/SegPC-2021-main/data/validation/y'
...
if __name__ == '__main__':
    sub = './submission.txt'
    #sub = './model_and_log/model_and_log_step2_oldpro/kd_result_ncCombine_val_4020/submission.txt'
    #sub = './model_and_log/model_and_log_step2_KDmib/segment_result_ncCombine_val_4020/submission.txt'
    score = evaluate(sub)
    print(lower_score_num)
    print(score)
