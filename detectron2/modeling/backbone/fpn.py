...
class FPN(Backbone):
    ...
    def __init__(
        ...
        #self attention
        #self.attention = Self_Attn(2048, 'relu')  #原本使用256
    ...
    def forward(self, x):
        ...
        #====================================================================
        #新的 self_attention 加入位置==========================================
        """bu_features = {}
        for fea in bottom_up_features:
            bu_fea = bottom_up_features.get(fea)
            if fea == 'res5':
                #print('in if')
                bu_fea, _ = self.attention(bu_fea)    # ========================新增的 self attention 在這裡，對所有 feature map 做 self attention
            bu_features[fea] = bu_fea
        ##print('bu_features')
        bottom_up_features = bu_features """
        #====================================================================
        results = []
        prev_features = self.lateral_convs[0](bottom_up_features[self.in_features[-1]])
        #prev_features = self.attention(prev_features)
