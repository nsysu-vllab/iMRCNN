...
#cfg.MODEL.WEIGHTS = model_zoo.get_checkpoint_url("Misc/cascade_mask_rcnn_X_152_32x8d_FPN_IN5k_gn_dconv.yaml")   # cascade_mrcnn pretrained model
cfg.MODEL.WEIGHTS = os.path.join(args.weight_folder, args.weight_file)  # path to the model weight just trained
