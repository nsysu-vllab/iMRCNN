...
args.add_argument('--iterations',type=int,default=6000) #20000 #最新測試是15000
...
class Transformer_Effb5(Backbone):
    ...
    def forward(self, image):
      ...
      print('transformer_features[0].shape')
      print(transformer_features[0].shape)
...
class attention_FPN(Backbone):
    ...
    def __init__(
        ...
        #self attention
        self.attention = Self_Attn(in_dim = bottom_up.output_shape())
...
#cfg.MODEL.WEIGHTS = os.path.join("/home/frank/Desktop/instance segmentation/SegPC-2021-main/model_and_log/model_multistep/model_and_log_fintune_step2/", "model_0005999.pth")  # path to the model weight just trained
...
cfg.SOLVER.BASE_LR = 0.02/5
cfg.SOLVER.LR_SCHEDULER_NAME = 'WarmupCosineLR'

cfg.SOLVER.WARMUP_ITERS = 1500 #1500 origin
...
#cfg.MODEL.BACKBONE.NAME = 'attention_FPN'
